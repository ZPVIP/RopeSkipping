...
- (void) serverManagerCannotConnectToClient{
    [self.delegate proximityServerCannotConnectToClient];
}
- (void) serverManagerDisconnect{
    [self.delegate proximityServerDisconnect];
}
@end
